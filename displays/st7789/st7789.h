...
#define ST7789_ROTATION 3
    ...
    #define CHUNK_SIZE_LINES	(19)
#endif

/* Display buffer transferred by chunks, with size [ST7789_WIDTH * CHUNK_SIZE_LINES] */
#ifndef CHUNK_SIZE_LINES
    #define CHUNK_SIZE_LINES	(19) //WARN: CHECK ST7789_HEIGHT % CHUNK_SIZE_LINES == 0!!!
#endif
